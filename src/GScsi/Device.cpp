...
bool Device_t::read_capacity(Scsi::Capacity10_t& capacity10)
{
  ...
  try
  {
    ...
    Util::IOBuffer_t response(READ_CAP10_REPLY_LEN);
...
bool Device_t::read_capacity(Scsi::Capacity16_t& capacity16)
{
  ...
  try
  {
    ...
    Util::IOBuffer_t response(READ_CAP16_REPLY_LEN);
...
bool Device_t::inquiry(Scsi::Inquiry::Standard_t& inquiry)
{
  ...
  try
  {
    ...
    Util::IOBuffer_t response(INQUIRY_STANDARD_REPLY_LEN+512);
...
bool Device_t::p_inquiry(Scsi::Inquiry::BasicVPD_t* vpd)
{
  ...
  try
  {
    ...
    Util::IOBuffer_t response(512); // Good enough for most Inquiry
...
void Device_t::p_read(Scsi::Read16_t& read16, Scsi::Sense_t* sense/* = nullptr */) throw (std::string)
{
  try
  {
    Util::IOBuffer_t request = read16.get();
    Util::IOBuffer_t ioBufferSense(SENSE_BUFFER_REPLY_LEN_MAX);
...
void Device_t::p_write(Scsi::Write16_t& write16, Scsi::Sense_t* sense/* = nullptr */) throw (std::string)
{
  try
  {
    Util::IOBuffer_t request = write16.get();
    Util::IOBuffer_t ioBufferSense(SENSE_BUFFER_REPLY_LEN_MAX);
